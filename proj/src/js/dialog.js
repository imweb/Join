...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['jquery', 'template/common'], factory);
    } else {
    ...
    !function($) {
        ...
        $.Dialog = {
            show: function(opt) {
                ...
                var modal =  $(TmplInline_common.modal({dialog: opt})).insertAfter('.modal-bg');
                ...
                opt.onAccept && $('.tips .modal-accept').on('click', function(e) {
                    e.preventDefault();
